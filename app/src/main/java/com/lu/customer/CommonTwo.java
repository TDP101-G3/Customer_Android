...
public class CommonTwo {
    ...
    public static final String SERVER_URI =
            "ws://10.0.2.2:8080/Customer_Web/TwoChatServer/";
    ...
    public static void saveDriverName(Context context, String driverName) {
        SharedPreferences preferences =
                context.getSharedPreferences("driver", MODE_PRIVATE);
        preferences.edit().putString("driverName", driverName).apply();
    }

    public static String loadDriverName(Context context) {
        SharedPreferences preferences =
                context.getSharedPreferences("driver", MODE_PRIVATE);
