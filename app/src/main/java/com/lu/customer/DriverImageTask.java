...
public class DriverImageTask extends AsyncTask<Object, Integer, Bitmap> {
    ...
    // 取單張圖片
    public DriverImageTask(String url, int driver_id, int imageSize) {
        this(url, driver_id, imageSize, null);
    }

    // 取完圖片後使用傳入的ImageView顯示，適用於顯示多張圖片
    public DriverImageTask(String url, int driver_id, int imageSize, ImageView imageView) {
        this.url = url;
